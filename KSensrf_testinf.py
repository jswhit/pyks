...
covinflate1 = float(sys.argv[1])
covinflate2 = float(sys.argv[2])
corrl = float(sys.argv[3])
...
gaussian = True # Gaussian or running average smoothing in H.
...
for nassim in range(0,ntot,nsteps):
    ...
    # RTPS posterior inflation (Whitaker and Hamill)
    if covinflate1 < 0.:
